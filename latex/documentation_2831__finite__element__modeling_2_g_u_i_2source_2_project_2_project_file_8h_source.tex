\hypertarget{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_project_2_project_file_8h_source}{}\doxysection{Project\+File.\+h}
\label{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_project_2_project_file_8h_source}\index{831\_finite\_element\_modeling/GUI/source/Project/ProjectFile.h@{831\_finite\_element\_modeling/GUI/source/Project/ProjectFile.h}}
...
\DoxyCodeLine{10     \textcolor{keyword}{class }ProcessController \{}
\DoxyCodeLine{11     \textcolor{keyword}{public}:}
\DoxyCodeLine{12         ProcessController(std::unique\_ptr<InstrumentController>\&\& ptr\_instrument\_controller = \textcolor{keyword}{nullptr},}
...
\DoxyCodeLine{59         \}}
\DoxyCodeLine{60 }
\DoxyCodeLine{61         InstrumentController\& get\_instrument\_controller() \{ \textcolor{keywordflow}{return} *m\_ptr\_instrument\_controller; \}}
\DoxyCodeLine{62         \textcolor{keyword}{const} InstrumentController\& get\_instrument\_controller()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_instrument\_controller; \}}
\DoxyCodeLine{63         StepController\& get\_step\_controller() \{ \textcolor{keywordflow}{return} *m\_ptr\_step\_controller; \}}
\DoxyCodeLine{64         \textcolor{keyword}{const} StepController\& get\_step\_controller()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_step\_controller; \}}
\DoxyCodeLine{65         RemeshingController\& get\_remeshing\_controller() \{ \textcolor{keywordflow}{return} *m\_ptr\_remeshing\_controller; \}}
\DoxyCodeLine{66         \textcolor{keyword}{const} RemeshingController\& get\_remeshing\_controller()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_remeshing\_controller; \}}
\DoxyCodeLine{67 }
\DoxyCodeLine{68         StopCondition\& get\_stop\_condition() \{ \textcolor{keywordflow}{return} *m\_ptr\_stop\_condition; \}}
\DoxyCodeLine{69         \textcolor{keyword}{const} StopCondition\& get\_stop\_condition()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_stop\_condition; \}}
\DoxyCodeLine{70         RemeshingCondition\& get\_remeshing\_condition() \{ \textcolor{keywordflow}{return} *m\_ptr\_remeshing\_condition; \}}
\DoxyCodeLine{71         \textcolor{keyword}{const} RemeshingCondition\& get\_remeshing\_condition()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_remeshing\_condition; \}}
\DoxyCodeLine{72 }
...
\DoxyCodeLine{79     \};}
\DoxyCodeLine{80 }
\DoxyCodeLine{81     \textcolor{keyword}{class }Project \{}
\DoxyCodeLine{82     \textcolor{keyword}{public}:}
\DoxyCodeLine{83         Project(std::unique\_ptr<Sample>\&\& ptr\_sample = \textcolor{keyword}{nullptr},}
...
\DoxyCodeLine{187         \mbox{\hyperlink{class_sample}{Sample}}\& get\_sample() \{ \textcolor{keywordflow}{return} *m\_ptr\_sample; \}}
\DoxyCodeLine{188         \textcolor{keyword}{const} \mbox{\hyperlink{class_sample}{Sample}}\& get\_sample()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_sample; \}}
\DoxyCodeLine{189         \mbox{\hyperlink{class_instrument}{Instrument}}\& get\_instrument() \{ \textcolor{keywordflow}{return} *m\_ptr\_instrument; \}}
\DoxyCodeLine{190         \textcolor{keyword}{const} \mbox{\hyperlink{class_instrument}{Instrument}}\& get\_instrument()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_instrument; \}}
\DoxyCodeLine{191 }
\DoxyCodeLine{192         Material\& get\_material() \{ \textcolor{keywordflow}{return} *m\_ptr\_material; \}}
\DoxyCodeLine{193         \textcolor{keyword}{const} Material\& get\_material()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_material; \}}
\DoxyCodeLine{194 }
\DoxyCodeLine{195         SaveResults\& get\_save\_results() \{ \textcolor{keywordflow}{return} *m\_ptr\_save\_results; \}}
\DoxyCodeLine{196         \textcolor{keyword}{const} SaveResults\& get\_save\_results()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_save\_results; \}}
\DoxyCodeLine{197 }
\DoxyCodeLine{198         ProcessController\& get\_process\_controller() \{ \textcolor{keywordflow}{return} *m\_ptr\_process\_controller; \}}
\DoxyCodeLine{199         \textcolor{keyword}{const} ProcessController\& get\_process\_controller()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} *m\_ptr\_process\_controller; \}}
\DoxyCodeLine{200         InstrumentController\& get\_instrument\_controller() \{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_instrument\_controller(); \}}
\DoxyCodeLine{201         \textcolor{keyword}{const} InstrumentController\& get\_instrument\_controller()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_instrument\_controller(); \}}
\DoxyCodeLine{202         StepController\& get\_step\_controller() \{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_step\_controller(); \}}
\DoxyCodeLine{203         \textcolor{keyword}{const} StepController\& get\_stept\_controller()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_step\_controller(); \}}
\DoxyCodeLine{204         RemeshingController\& get\_remeshing\_controller() \{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_remeshing\_controller(); \}}
\DoxyCodeLine{205         \textcolor{keyword}{const} RemeshingController\& get\_remeshing\_controller()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_remeshing\_controller(); \}}
\DoxyCodeLine{206         StopCondition\& get\_stop\_condition() \{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_stop\_condition(); \}}
\DoxyCodeLine{207         \textcolor{keyword}{const} StopCondition\& get\_stop\_condition()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_stop\_condition(); \}}
\DoxyCodeLine{208         RemeshingCondition\& get\_remeshing\_condition() \{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_remeshing\_condition(); \}}
\DoxyCodeLine{209         \textcolor{keyword}{const} RemeshingCondition\& get\_remeshing\_condition()\textcolor{keyword}{ const }\{ \textcolor{keywordflow}{return} m\_ptr\_process\_controller-\/>get\_remeshing\_condition(); \}}

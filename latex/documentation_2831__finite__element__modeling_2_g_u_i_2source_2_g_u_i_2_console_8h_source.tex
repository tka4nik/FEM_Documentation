\hypertarget{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_g_u_i_2_console_8h_source}{}\doxysection{Console.\+h}
\label{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_g_u_i_2_console_8h_source}\index{831\_finite\_element\_modeling/GUI/source/GUI/Console.h@{831\_finite\_element\_modeling/GUI/source/GUI/Console.h}}
...
\DoxyCodeLine{30     \textcolor{keyword}{class }Command;}
...
\DoxyCodeLine{39 }
\DoxyCodeLine{40 }
\DoxyCodeLine{50     \textcolor{keyword}{static} \mbox{\hyperlink{class_console}{Console}}* \mbox{\hyperlink{class_console_af5201cbdab135641c23c4672ca4b1faa}{Instance}}(std::istream\& input\_stream, std::ostream\& output\_log, std::ostream\& message\_log);}
\DoxyCodeLine{54     \textcolor{keyword}{static} \mbox{\hyperlink{class_console}{Console}}* \mbox{\hyperlink{class_console_a3b5ada0962a0cb0ea0db302deb830199}{Instance}}();}
\DoxyCodeLine{55 }
...
\DoxyCodeLine{159     \};}
\DoxyCodeLine{160 }
\DoxyCodeLine{171     DlgAnswer \mbox{\hyperlink{class_console_a81a1552ef98a21d37de51cfa73b9c7ac}{DlgQuestion}}(\textcolor{keyword}{const} std::string\& question, \textcolor{keyword}{const} std::string\& answ\_yes, \textcolor{keyword}{const} std::string\& answ\_no, \textcolor{keywordtype}{bool} loop = \textcolor{keyword}{false});}
\DoxyCodeLine{172 }
...
\DoxyCodeLine{198 }
\DoxyCodeLine{199 }
\DoxyCodeLine{205     \textcolor{keywordtype}{void} Execute(\mbox{\hyperlink{class_console_1_1_command}{Command}}\&, std::vector<std::string>\&\& args);}
\DoxyCodeLine{206 }
...
\DoxyCodeLine{285 }
\DoxyCodeLine{291     \mbox{\hyperlink{class_console_1_1_command_a047d898e97c7aa4da5f1eceaa452e032}{Command}}(\textcolor{keyword}{const} std::function<\textcolor{keywordtype}{void}(std::vector<std::string>\&)>\& func,\textcolor{keyword}{const} std::function<\textcolor{keywordtype}{bool}(std::vector<std::string>\&)>\& argument\_check);}
\DoxyCodeLine{292     }

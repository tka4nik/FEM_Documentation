\hypertarget{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_project_2_controllers_8h_source}{}\doxysection{Controllers.\+h}
\label{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_project_2_controllers_8h_source}\index{831\_finite\_element\_modeling/GUI/source/Project/Controllers.h@{831\_finite\_element\_modeling/GUI/source/Project/Controllers.h}}

\begin{DoxyCode}{0}
\DoxyCodeLine{1 \textcolor{preprocessor}{\#pragma once}}
\DoxyCodeLine{2 }
\DoxyCodeLine{3 \textcolor{keyword}{namespace }Proj \{}
\DoxyCodeLine{4     \textcolor{keyword}{class }InstrumentController \{}
...
\DoxyCodeLine{9     \};}
\DoxyCodeLine{10 }
\DoxyCodeLine{11     \textcolor{keyword}{class }ControllerConstSR : \textcolor{keyword}{public} InstrumentController \{}
\DoxyCodeLine{12     \textcolor{keyword}{public}:}
\DoxyCodeLine{13         ControllerConstSR(\textcolor{keywordtype}{double} strain\_rate = 0, \textcolor{keywordtype}{double} gauge\_length = 0) \{}
...
\DoxyCodeLine{37     \};}
\DoxyCodeLine{38 }
\DoxyCodeLine{39     \textcolor{keyword}{class }StepController \{}
...
\DoxyCodeLine{45     \};}
\DoxyCodeLine{46 }
\DoxyCodeLine{47     \textcolor{keyword}{class }ControllerConstStep : \textcolor{keyword}{public} StepController \{}
\DoxyCodeLine{48     \textcolor{keyword}{public}:}
\DoxyCodeLine{49         ControllerConstStep(\textcolor{keywordtype}{double} delta\_time = 0) \{}
...
\DoxyCodeLine{85     \};}
\DoxyCodeLine{86 }
\DoxyCodeLine{87     \textcolor{keyword}{class }RemeshingController \{ \textcolor{comment}{// То мелкая сетка, то крупная:}}
\DoxyCodeLine{88     \textcolor{keyword}{public}:}
\DoxyCodeLine{89         RemeshingController(\textcolor{keywordtype}{double} length = 0.3): m\_edge\_length(length) \{\}}
...
\DoxyCodeLine{92         \}}
\DoxyCodeLine{93         RemeshingController(\textcolor{keyword}{const} RemeshingController\&) = \textcolor{keywordflow}{default};}

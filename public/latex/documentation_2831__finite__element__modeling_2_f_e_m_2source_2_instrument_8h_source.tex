\hypertarget{documentation_2831__finite__element__modeling_2_f_e_m_2source_2_instrument_8h_source}{}\doxysection{Instrument.\+h}
\label{documentation_2831__finite__element__modeling_2_f_e_m_2source_2_instrument_8h_source}\index{831\_finite\_element\_modeling/FEM/source/Instrument.h@{831\_finite\_element\_modeling/FEM/source/Instrument.h}}
...
\DoxyCodeLine{24 }
\DoxyCodeLine{28     \textcolor{keyword}{class }Profile \{}
...
\DoxyCodeLine{32         std::vector<double>\& GetMeshXY();}
...
\DoxyCodeLine{38         \}}
\DoxyCodeLine{39         Profile\& operator=(Profile\&\&);}
...
\DoxyCodeLine{47 }
\DoxyCodeLine{48     \textcolor{keywordtype}{void} \mbox{\hyperlink{class_instrument_afe51f5abdddf7147efa02f25ed4eb3d0}{Load}}(\textcolor{keyword}{const} \textcolor{keywordtype}{char}* data, \textcolor{keywordtype}{size\_t} n); }
...
\DoxyCodeLine{93 }
\DoxyCodeLine{94     \textcolor{keywordtype}{void} get\_field(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} \textcolor{keywordtype}{id}, \textcolor{keywordtype}{void}*\& ptr\_field, \textcolor{keywordtype}{size\_t}\& size);}
\DoxyCodeLine{95 }
\DoxyCodeLine{96     \textcolor{keyword}{enum class} \mbox{\hyperlink{class_instrument_adc3f664282423050cf087c62fe26d0bc}{FieldId}} \{}
\DoxyCodeLine{97         \mbox{\hyperlink{class_instrument_adc3f664282423050cf087c62fe26d0bca1b8a8605d2ff5670a215e55c6645e0d9}{OFFSET}},       }
\DoxyCodeLine{98         \mbox{\hyperlink{class_instrument_adc3f664282423050cf087c62fe26d0bca48359f9afd830d28b1152d071fb09147}{PROFILE}}      }
\DoxyCodeLine{99     \};}
\DoxyCodeLine{100 }
\DoxyCodeLine{101 \textcolor{keyword}{private}:}
\DoxyCodeLine{102     }
\DoxyCodeLine{103     Profile m\_Profile0; }
\DoxyCodeLine{107     \textcolor{keywordtype}{void} ExtractProfile0(std::vector<double>\&\& MeshX, std::vector<double>\&\& MeshY, std::vector<int>\&\& IJK);}
\DoxyCodeLine{108 }
\DoxyCodeLine{109     \textcolor{keywordtype}{double} m\_offset; }
\DoxyCodeLine{110     \textcolor{keywordtype}{double} m\_velocity\_Y;    }
\DoxyCodeLine{111 \};}

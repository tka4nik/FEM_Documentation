\hypertarget{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_reverse_analysis_2_experiment_8h_source}{}\doxysection{Experiment.\+h}
\label{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_reverse_analysis_2_experiment_8h_source}\index{831\_finite\_element\_modeling/GUI/source/ReverseAnalysis/Experiment.h@{831\_finite\_element\_modeling/GUI/source/ReverseAnalysis/Experiment.h}}
...
\DoxyCodeLine{17     \textcolor{keyword}{enum class} constraints \{ \mbox{\hyperlink{group__core__func__common_ga6cf8098827054a270ee36b18e30d471d}{min}}, \mbox{\hyperlink{group__core__func__common_gae02d42887fc5570451f880e3c624b9ac}{max}}, start, end \};}
\DoxyCodeLine{18 }
\DoxyCodeLine{19     \textcolor{keyword}{class }Experiment \{}
...
\DoxyCodeLine{31         Experiment(\textcolor{keyword}{const} Experiment\& experiment, \textcolor{keyword}{const} \mbox{\hyperlink{class_iter_1_1_coef_k}{Iter::CoefK}}\& coef\_k);}
\DoxyCodeLine{32         Experiment(\textcolor{keyword}{const} std::string\& file\_name);}
\DoxyCodeLine{33 }
...
\DoxyCodeLine{74     \};}
\DoxyCodeLine{75 }
\DoxyCodeLine{76     \textcolor{keyword}{class }ExperimentContainer \{}
\DoxyCodeLine{77     \textcolor{keyword}{public}:}
\DoxyCodeLine{78         ExperimentContainer(\textcolor{keyword}{const} std::string\& path);}
\DoxyCodeLine{79 }
\DoxyCodeLine{80         ExperimentContainer(std::vector<Experiment>\&\& experiments);}
\DoxyCodeLine{81 }
...
\DoxyCodeLine{90 }
\DoxyCodeLine{91         ExperimentContainer(\textcolor{keyword}{const} ExperimentContainer\& experiments, \textcolor{keyword}{const} \mbox{\hyperlink{class_iter_1_1_coef_k_container}{Iter::CoefKContainer}}\& coefk\_container);}
\DoxyCodeLine{92 }
...
\DoxyCodeLine{110     \};}
\DoxyCodeLine{111 }
\DoxyCodeLine{112     std::pair<ExperimentContainer, ExperimentContainer> const\_jumps\_experiments(ExperimentContainer\& container);}
\DoxyCodeLine{113 }
\DoxyCodeLine{114     \mbox{\hyperlink{class_proj_1_1_backofen}{Proj::Backofen}} backofen\_from\_experiment(\textcolor{keyword}{const} ExperimentContainer\& experiments);}
\DoxyCodeLine{115 \}}

\hypertarget{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_g_u_i_2_window_8h_source}{}\doxysection{Window.\+h}
\label{documentation_2831__finite__element__modeling_2_g_u_i_2source_2_g_u_i_2_window_8h_source}\index{831\_finite\_element\_modeling/GUI/source/GUI/Window.h@{831\_finite\_element\_modeling/GUI/source/GUI/Window.h}}
...
\DoxyCodeLine{15 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{vec2_8hpp}{glm/vec2.hpp}}"{}}}
...
\DoxyCodeLine{48     \textcolor{keyword}{static} \mbox{\hyperlink{class_window}{Window}}* \mbox{\hyperlink{class_window_a7bbe763bb42274f75619354ba31fea6d}{Instance}}();}
\DoxyCodeLine{59     \textcolor{keyword}{static} \mbox{\hyperlink{class_window}{Window}}* \mbox{\hyperlink{class_window_a93f4f6bb869e877dd4dff53d2455a21d}{Instance}}(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv, \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} win\_size, \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} win\_offset, \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} proj\_rect, \textcolor{keyword}{const} \textcolor{keywordtype}{char}* title);}
\DoxyCodeLine{60 }
\DoxyCodeLine{65     \textcolor{keywordtype}{void} \mbox{\hyperlink{class_window_a87b902697d9b23178d1bf4d0e1fae978}{SetOffset}}(\mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} camera\_offset);}
\DoxyCodeLine{66 }
\DoxyCodeLine{71     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} \mbox{\hyperlink{class_window_ab9dc84bac40c574fbd5cad0ddc961e9c}{GetOffset}}()\textcolor{keyword}{const};}
\DoxyCodeLine{72 }
...
\DoxyCodeLine{106 }
\DoxyCodeLine{110     \textcolor{keywordtype}{void} \mbox{\hyperlink{class_window_abf99605eefa6e9cd704e5786eac88b1e}{SetCameraBounds}}(\mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} min\_view, \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} max\_view);}
\DoxyCodeLine{111 }
...
\DoxyCodeLine{140     \mbox{\hyperlink{class_window}{Window}}(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv, \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} win\_size, \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} win\_offset, \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} proj\_rect, \textcolor{keyword}{const} \textcolor{keywordtype}{char}* title);}
\DoxyCodeLine{141 }
...
\DoxyCodeLine{150 }
\DoxyCodeLine{155     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} GetRealCoords(\textcolor{keywordtype}{int} x, \textcolor{keywordtype}{int} y);}
\DoxyCodeLine{156 }
\DoxyCodeLine{157 }
...
\DoxyCodeLine{161 }
\DoxyCodeLine{162     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} m\_init\_view\_proj; \textcolor{comment}{//начальная область видимости камеры}}
\DoxyCodeLine{163     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} m\_current\_view\_proj; \textcolor{comment}{//текущая облать видимости}}
\DoxyCodeLine{164     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} m\_camera\_offset = \{ 0,0 \}; \textcolor{comment}{//смещение центра камеры}}
\DoxyCodeLine{165     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} m\_min\_view; \textcolor{comment}{//минимальная область видимости}}
\DoxyCodeLine{166     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} m\_max\_view; \textcolor{comment}{//максимальная область видимости}}
...
\DoxyCodeLine{169 }
\DoxyCodeLine{170     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} m\_start\_pos = \{0,0\}; \textcolor{comment}{//позиция мыши при последнем нажатии левой кнопки мыши}}
\DoxyCodeLine{171     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} m\_init\_offset = \{0,0\}; \textcolor{comment}{//смещение камеры на момент последнего нажатия левой кнопки мыши}}
\DoxyCodeLine{172     }
\DoxyCodeLine{173     }
\DoxyCodeLine{174     \mbox{\hyperlink{class_f_t_g_l_polygon_font}{FTGLPolygonFont}} m\_font; \textcolor{comment}{//объект шрифта}}
\DoxyCodeLine{175 }
...
\DoxyCodeLine{187     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} m\_right\_button\_click\_pos;\textcolor{comment}{//позиция при последнем нажатии правой кнопки мыши}}
...
\DoxyCodeLine{189 }
\DoxyCodeLine{190     \mbox{\hyperlink{structglm_1_1vec}{glm::vec2}} m\_current\_cursor\_pos; \textcolor{comment}{//текущее положение курсора}}
\DoxyCodeLine{191 }
